...
public final class Klient {
	...
	public static void main(String args[]) throws Exception {
		...
		try {
			...
			System.out.println("Hind ei tohi negatiivne olla "+e); 
			break;
		} catch(HinnakiriNullNumberFormatException e) {
			System.out.println("Hind ei tohi null olla "+e);
			break;
		} catch(HinnakiriPrecisionException e) {
			System.out.println("Hinnas voib 2 koma kohta olla "+e);
			break;
		}
		catch(Exception e) {
			System.out.println("Ei saanud serveriga ühendus:"+ (i+1) +"korral");
		} 
		Thread.sleep(2000);
	}
		if(response == null)
